...
class MyModule extends Module
{
    ...
    public function hookDisplayHome($params)        // weather API defined OLSZTYN
    {
        ...
        if ($weatherData) 
        {
            ...
            $temperatureF = $weather->convertToFahrenheit($temperatureC);
            $weatherDescription = $weatherData['weather'][0]['description'];
            $weatherIcon = $weather->getWeatherIconUrl($weatherData['weather'][0]['icon']);

             // Debugging lines
    error_log("TemperatureC: " . $temperatureC);
    error_log("TemperatureF: " . $temperatureF);
    error_log("WeatherDescription: " . $weatherDescription);
    error_log("WeatherIcon: " . $weatherIcon);
